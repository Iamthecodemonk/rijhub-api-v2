...
const transactionSchema = new mongoose.Schema({
  ...
  paystackSplit: { type: Boolean, default: false },
  paystackSubaccountCode: { type: String },
  paystackSplitBearer: { type: String },
  paystackTransactionCharge: { type: Number },
  paystackSplitMeta: { type: mongoose.Schema.Types.Mixed },
